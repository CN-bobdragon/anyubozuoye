...
<head>
    ...
    <script type="text/javascript">
        //导出信息
        function daochu() {
            var url = "${contextPath}/leixingChakan?d=1";
        ...
        function leixingDel(id) {
            if (confirm('您确定删除吗?')) {
                $.get(basePath + '/leixingDel/' + id, function (resp) {
                    if (resp.success) {
                        alert("删除成功！");
                        //window.location.href = "${contextPath}/leixingChankan";
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px"
       bordercolor="#008080">
    <form action="${contextPath}/leixingChakan" name="formSearch" id="formSearch" method="post">
        <div>
    ...
    <tr bgcolor="#E7E7E7">
        <td height="14" colspan="100" background="${staticPath}/images/tbg.gif">类型查看</td>
    </tr>
