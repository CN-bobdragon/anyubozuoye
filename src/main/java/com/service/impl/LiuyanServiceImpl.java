...
public class LiuyanServiceImpl implements LiuyanService {
    ...
    //根据条件(字符类型模糊匹配)查询留言咨询表liuyan最后一条数据
    @Override
    ...
    //根据条件(字符类型完全匹配)查询留言咨询表liuyan最后一条数据
    @Override
    ...
    //根据条件(字符类型模糊匹配)分页查询留言咨询表liuyan数据
    @Override
    ...
    //根据条件(字符类型完全匹配)分页查询留言咨询表liuyan数据
    @Override
    ...
    private LiuyanExample getLiuyanExampleByLike(Liuyan instance) {
        ...
        //时间tianjiashijian模糊匹配
        if (null != instance.getTianjiashijian() && !instance.getTianjiashijian().equals("")) {
            criteria.andTianjiashijianLike("%" + instance.getTianjiashijian() + "%");
        }
        //用户idusersid完全匹配
    ...
    private LiuyanExample getLiuyanExampleByEqualTo(Liuyan instance) {
        ...
        //时间tianjiashijian完全匹配
        if (null != instance.getTianjiashijian() && !instance.getTianjiashijian().equals("")) {
            criteria.andTianjiashijianEqualTo(instance.getTianjiashijian());
        }
        //用户idusersid完全匹配
        if (null != instance.getUsersid()) {
            criteria.andUsersidEqualTo(instance.getUsersid());
