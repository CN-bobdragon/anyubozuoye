...
<div class="container">
    <ul class="g-firstsec2-list">
        ...
        小组:
        <select style="border:solid 1px #000000; color:#666666;" name="xiaozuid" id="xiaozuid">
...
<%--                    <td width="40" align="center" bgcolor="">序号</td>--%>
        <td bgcolor='' align="center">小组</td>
        <td bgcolor='' align="center">用户</td>
        <td bgcolor='' align="center">申请</td>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <td width="50px" align="center">
                            <a href="${contextPath}/shenqingDetailQian/${info.id}">
                                详细
                            </a>
                        </td>
                    </tr>
