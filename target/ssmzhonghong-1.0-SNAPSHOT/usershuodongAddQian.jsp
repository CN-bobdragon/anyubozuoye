        ...
        function huodongAdd() {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.success) {
                        alert("添加成功！");
                        //window.location.href = "${contextPath}/huodongManaMyQian";
                    } else {
                        alert(resp.message);
                    }
                }
                ...
                <textarea name="neirong" id="neirong" style="width:670px;height:200px;" size="70px"></textarea>
                    ...
                    <tr align='center'   height="22">
                        ...
                        <td width="75%"  align="left">
                            <input type="button" name="querenzhuce" id="querenzhuce" value="提交" onClick="huodongAdd();"/>
