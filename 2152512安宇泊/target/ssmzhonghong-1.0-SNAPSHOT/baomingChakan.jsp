...
<head>
    ...
    <script type="text/javascript">
        //导出信息
        function daochu() {
            var url = "${contextPath}/baomingChakan?d=1";
        ...
        function baomingDel(id) {
            if (confirm('您确定删除吗?')) {
                $.get(basePath + '/baomingDel/' + id, function (resp) {
                    if (resp.success) {
                        alert("删除成功！");
                        //window.location.href = "${contextPath}/baomingChankan";
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px"
       bordercolor="#008080">
    <form action="${contextPath}/baomingChakan" name="formSearch" id="formSearch" method="post">
        <div>
        活动:
