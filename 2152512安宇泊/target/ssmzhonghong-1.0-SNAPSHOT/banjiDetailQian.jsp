...
<head>
    ...
    <script language="javascript">
        ...
        //跳转到子表users添加页面
        function banjiusersAddQian(id) {
            var url="${contextPath}/banjiusersAddQian/"+id;
            window.location.href=url;
        }
        //跳转到子表users查看页面
        function banjiusersGetBybanjiidQian(id) {
            var url="${contextPath}/banjiusersGetBybanjiidQian/"+id;
            window.location.href=url;
        }
    ...
    <tr>
        ...
        <td width="39%">
            ${banji.mingcheng }
                ...
                <input type="button" value="用户添加" onclick="banjiusersAddQian(${banji.id})"/>
                <input type="button" value="用户查看" onclick="banjiusersGetBybanjiidQian(${banji.id})"/>
