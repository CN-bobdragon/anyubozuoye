...
<form name="formAdd" id="formAdd">
    <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC"
        ...
        <tr bgcolor="#EEF4EA">
            <td colspan="3" background="${staticPath}/img/wbg.gif" class='title'><span>&nbsp;班级修改</span>
            </td>
        </tr>
		<tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <input type="text" name="mingcheng" id="mingcheng" value="${banji.mingcheng }" size="90px"/>
            </td>
        ...
        <tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <input type="hidden" id="id" name="id" value="${banji.id}"/>
                <input type="button" value="提交" onclick="banjiSet();"/>&nbsp;
